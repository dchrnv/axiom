# Axiom FastAPI Service Example

Example FastAPI service demonstrating async Axiom Python client integration.
...
- Python + FastAPI + Axiom async client
- CORS enabled
...
```bash
docker build -t axiom-fastapi-service .
docker run -p 8001:8001 --env-file .env axiom-fastapi-service
```

## Features Demonstrated

- Async/await with AsyncAxiomClient
