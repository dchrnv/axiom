# Axiom Python Examples

This directory contains example scripts demonstrating the axiom Python library.

## Examples

### 1. Basic Usage (`basic_usage.py`)

Introduction to the axiom API:
