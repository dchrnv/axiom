...
"""
Axiom WebSocket Client (Python)

Python client for Axiom WebSocket API
Version: v0.60.0

Example:
    >>> from axiom_ws_client import NeurographWSClient
    >>>
...
class NeurographWSClient:
    """
    Python WebSocket client for Axiom real-time events.
