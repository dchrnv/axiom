# Axiom Client Libraries

Official client libraries for connecting to Axiom WebSocket API.

## Available Clients

### TypeScript/JavaScript Client

**File:** `typescript/axiom-ws-client.ts`
...
cp typescript/axiom-ws-client.ts your-project/src/
...
**File:** `python/axiom_ws_client.py`
...
# Copy the file to your project
cp python/axiom_ws_client.py your-project/
```
...
- **Issues:** https://github.com/anthropics/axiom-os-mvp/issues
- **Discord:** Coming soon
