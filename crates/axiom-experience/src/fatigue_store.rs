...
//
// FatigueStore — усталость подсистем (CR-V6 Фаза B / V7-B2).
//
// Перенесено из axiom-runtime/context_recognizer/subsystem_fatigue.rs в V7-B2.
// Жизненный цикл fatigue не должен зависеть от ContextRecognizer.
