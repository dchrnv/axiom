...
Automated CI/CD pipelines for Axiom project.
...
4. Check Test PyPI: https://test.pypi.org/project/axiom-python/

Install from Test PyPI:
```bash
pip install --index-url https://test.pypi.org/simple/ axiom-python==0.59.3
```
...
- PyPI: https://pypistats.org/packages/axiom-python
- npm: https://www.npmjs.com/package/@axiom/client

### Coverage Reports

- Codecov: https://codecov.io/gh/YOUR_USERNAME/axiom-os
