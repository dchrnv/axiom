...
/// 1/255 → след живёт ~255 тиков при temperature=255 (достаточно для OBS-снапшота).
/// Resolution-tensions создаются с temperature=255 → видны ~255 тиков после разрешения.
const TENSION_DECAY: u8 = 1;
