"""
Custom exceptions for Axiom API.
...
class ResourceError(AxiomException):
    """Base resource error."""
    pass
...
class ServiceError(AxiomException):
    """Base service error."""
    pass
...
class ConfigurationError(AxiomException):
    """Configuration error."""
