...
Rust implementation of **Axiom Token V2.0** - the fundamental data structure for token-based computing in 8-dimensional semantic space.
...
```rust
use axiom_core::{Token, CoordinateSpace, EntityType, flags};
