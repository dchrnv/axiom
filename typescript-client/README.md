...
Official TypeScript/JavaScript client library for [Axiom](https://github.com/dchrnv/axiom-os) - semantic knowledge system based on token embeddings.

[![npm version](https://img.shields.io/npm/v/@axiom/client)](https://www.npmjs.com/package/@axiom/client)
...
```bash
npm install @axiom/client
```

Or with other package managers:

```bash
yarn add @axiom/client
pnpm add @axiom/client
bun add @axiom/client
```
...
const apiClient = new AxiomClient({
  baseUrl: 'http://localhost:8000',
...
try {
  ...
  } else if (error instanceof AxiomError) {
...
```typescript
import { retryWithBackoff } from '@axiom/client';
...
```typescript
import type { Token, TokenCreate, QueryResult } from '@axiom/client';
...
- **npm**: https://www.npmjs.com/package/@axiom/client
