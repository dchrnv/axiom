...
impl PyConnectionType {
    ...
    #[staticmethod]
    fn Synonym() -> Self {
        PyConnectionType { inner: ConnectionType::Synonym }
    }

    #[staticmethod]
    fn Antonym() -> Self {
        PyConnectionType { inner: ConnectionType::Antonym }
    }

    #[staticmethod]
    fn Hypernym() -> Self {
        PyConnectionType { inner: ConnectionType::Hypernym }
    }

    #[staticmethod]
    fn Hyponym() -> Self {
        PyConnectionType { inner: ConnectionType::Hyponym }
    }

    #[staticmethod]
    fn Meronym() -> Self {
        PyConnectionType { inner: ConnectionType::Meronym }
    }

    #[staticmethod]
    fn Holonym() -> Self {
        PyConnectionType { inner: ConnectionType::Holonym }
    }

    // Causal connections (0x10-0x1F)
    #[staticmethod]
    fn Cause() -> Self {
        PyConnectionType { inner: ConnectionType::Cause }
    }

    #[staticmethod]
    fn Effect() -> Self {
        PyConnectionType { inner: ConnectionType::Effect }
    }

    #[staticmethod]
    fn EnabledBy() -> Self {
        PyConnectionType { inner: ConnectionType::EnabledBy }
    }

    #[staticmethod]
    fn PreventedBy() -> Self {
        PyConnectionType { inner: ConnectionType::PreventedBy }
    }

    // Temporal connections (0x20-0x2F)
    #[staticmethod]
    fn Before() -> Self {
        PyConnectionType { inner: ConnectionType::Before }
    }

    #[staticmethod]
    fn After() -> Self {
        PyConnectionType { inner: ConnectionType::After }
    }

    #[staticmethod]
    fn During() -> Self {
        PyConnectionType { inner: ConnectionType::During }
    }

    #[staticmethod]
    fn Simultaneous() -> Self {
        PyConnectionType { inner: ConnectionType::Simultaneous }
    }

    // Spatial connections (0x30-0x3F)
    #[staticmethod]
    fn Near() -> Self {
        PyConnectionType { inner: ConnectionType::Near }
    }

    #[staticmethod]
    fn Far() -> Self {
        PyConnectionType { inner: ConnectionType::Far }
    }

    #[staticmethod]
    fn Inside() -> Self {
        PyConnectionType { inner: ConnectionType::Inside }
    }

    #[staticmethod]
    fn Outside() -> Self {
        PyConnectionType { inner: ConnectionType::Outside }
    }

    #[staticmethod]
    fn Above() -> Self {
        PyConnectionType { inner: ConnectionType::Above }
    }

    #[staticmethod]
    fn Below() -> Self {
        PyConnectionType { inner: ConnectionType::Below }
    }

    // Logical connections (0x40-0x4F)
    #[staticmethod]
    fn And() -> Self {
        PyConnectionType { inner: ConnectionType::And }
    }

    #[staticmethod]
    fn Or() -> Self {
        PyConnectionType { inner: ConnectionType::Or }
    }

    #[staticmethod]
    fn Not() -> Self {
        PyConnectionType { inner: ConnectionType::Not }
    }

    #[staticmethod]
    fn Implies() -> Self {
        PyConnectionType { inner: ConnectionType::Implies }
    }

    #[staticmethod]
    fn Equivalent() -> Self {
        PyConnectionType { inner: ConnectionType::Equivalent }
    }

    // Associative connections (0x50-0x5F)
    #[staticmethod]
    fn Similar() -> Self {
        PyConnectionType { inner: ConnectionType::Similar }
    }

    #[staticmethod]
    fn Different() -> Self {
        PyConnectionType { inner: ConnectionType::Different }
    }

    #[staticmethod]
    fn Related() -> Self {
        PyConnectionType { inner: ConnectionType::Related }
    }

    #[staticmethod]
    fn Cooccurs() -> Self {
        PyConnectionType { inner: ConnectionType::Cooccurs }
    }

    // Structural connections (0x60-0x6F)
    #[staticmethod]
    fn PartOf() -> Self {
        PyConnectionType { inner: ConnectionType::PartOf }
    }

    #[staticmethod]
    fn Contains() -> Self {
        PyConnectionType { inner: ConnectionType::Contains }
    }

    #[staticmethod]
    fn MemberOf() -> Self {
        PyConnectionType { inner: ConnectionType::MemberOf }
    }

    #[staticmethod]
    fn SubclassOf() -> Self {
        PyConnectionType { inner: ConnectionType::SubclassOf }
    }

    #[staticmethod]
    fn InstanceOf() -> Self {
        PyConnectionType { inner: ConnectionType::InstanceOf }
    }

    // Functional connections (0x70-0x7F)
    #[staticmethod]
    fn Uses() -> Self {
        PyConnectionType { inner: ConnectionType::Uses }
    }

    #[staticmethod]
    fn UsedBy() -> Self {
        PyConnectionType { inner: ConnectionType::UsedBy }
    }

    #[staticmethod]
    fn Requires() -> Self {
        PyConnectionType { inner: ConnectionType::Requires }
    }

    #[staticmethod]
    fn Produces() -> Self {
        PyConnectionType { inner: ConnectionType::Produces }
    }

    #[staticmethod]
    fn Consumes() -> Self {
        PyConnectionType { inner: ConnectionType::Consumes }
    }

    // Emotional connections (0x80-0x8F)
    #[staticmethod]
    fn Likes() -> Self {
        PyConnectionType { inner: ConnectionType::Likes }
    }

    #[staticmethod]
    fn Dislikes() -> Self {
        PyConnectionType { inner: ConnectionType::Dislikes }
    }

    #[staticmethod]
    fn Fears() -> Self {
        PyConnectionType { inner: ConnectionType::Fears }
    }

    #[staticmethod]
    fn Desires() -> Self {
        PyConnectionType { inner: ConnectionType::Desires }
    }

    // Rule-based connections (0x90-0x9F)
    #[staticmethod]
    fn Constraint() -> Self {
        PyConnectionType { inner: ConnectionType::Constraint }
    }

    #[staticmethod]
    fn Condition() -> Self {
        PyConnectionType { inner: ConnectionType::Condition }
    }

    #[staticmethod]
    fn Consequence() -> Self {
        PyConnectionType { inner: ConnectionType::Consequence }
    }

    // Metaphorical connections (0xA0-0xAF)
    #[staticmethod]
    fn MetaphorFor() -> Self {
        PyConnectionType { inner: ConnectionType::MetaphorFor }
    }

    #[staticmethod]
    fn Symbolizes() -> Self {
        PyConnectionType { inner: ConnectionType::Symbolizes }
    }

    // Dynamic connections (0xB0-0xBF)
    #[staticmethod]
    fn Activates() -> Self {
        PyConnectionType { inner: ConnectionType::Activates }
    }

    #[staticmethod]
    fn Inhibits() -> Self {
        PyConnectionType { inner: ConnectionType::Inhibits }
    }

    #[staticmethod]
    fn Modulates() -> Self {
        PyConnectionType { inner: ConnectionType::Modulates }
    }
...
impl PyConnection {
    ...
    fn new(
        token_a_id: u32,
        token_b_id: u32,
        connection_type: PyConnectionType,
    ) -> Self {
        PyConnection {
