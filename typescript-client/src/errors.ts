/**
 * Error classes for Axiom client.
 */

import type { ErrorResponse } from './models';

/**
 * Base error class for all Axiom errors.
 */
export class AxiomError extends Error {
  ...
  static fromResponse(response: ErrorResponse, statusCode?: number): AxiomError {
    ...
    switch (error_code) {
      ...
      default:
        return new AxiomError(message, error_code, details, statusCode);
    }
  }
}
 ...
 */
export class ServerError extends AxiomError {
  constructor(message: string, errorCode: string, details?: any, statusCode?: number) {
