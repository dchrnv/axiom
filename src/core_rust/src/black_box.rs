...
///
/// ```rust
/// use axiom_core::black_box::{BlackBox, Event, EventType};
///
...
impl BlackBox {
    ...
    ///
    /// ```rust
    /// use axiom_core::black_box::BlackBox;
    ///
...
lazy_static! {
    ...
    ///
    /// ```rust
    /// use axiom_core::black_box::{GLOBAL_BLACK_BOX, Event, EventType};
    ///
...
///
/// ```rust
/// use axiom_core::black_box::{record_event, Event, EventType};
///
...
///
/// ```rust
/// use axiom_core::black_box::dump_to_file;
///
