...
from client_libraries.python.axiom_ws_client import NeurographWSClient, Channel
...
async def demo_metrics():
    ...
    print("\nKey metrics:")
    print("   - axiom_ws_connections_total")
    print("   - axiom_ws_messages_sent_total")
    print("   - axiom_ws_messages_received_total")
    print("   - axiom_ws_message_latency_seconds")
    print("   - axiom_ws_subscriptions_total")
    print("   - axiom_ws_channel_subscribers")
    print("   - axiom_ws_errors_total")
...
async def main():
    """Run all demos."""
    print("\n" + "="*60)
    print("Axiom WebSocket Advanced Features Demo (v0.60.1)")
    print("="*60)
