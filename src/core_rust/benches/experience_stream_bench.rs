...
use axiom_core::{ExperienceStream, ExperienceEvent, EventType, ActionMetadata};
use serde_json::json;
        ...
        b.iter(|| {
            ...
            stream
                ...
                .set_appraiser_reward(
                    black_box(seq),
                    black_box(axiom_core::AppraiserType::Homeostasis),
                    black_box(0.5),
                )
        })
    });
    ...
    group.bench_function("curiosity", |b| {
        ...
        b.iter(|| {
            ...
            stream
                ...
                .set_appraiser_reward(
                    black_box(seq),
                    black_box(axiom_core::AppraiserType::Curiosity),
                    black_box(0.3),
                )
        })
    });
