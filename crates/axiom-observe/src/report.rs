...
pub fn generate_markdown(
    ...
    out.push_str("| Tick | Exp traces | Tension | Frames | Profiles |\n|---|---|---|---|---|\n");
    for snap in snapshots {
        out.push_str(&format!(
            "| {} | {} | {} | {} | {} |\n",
            snap.tick, snap.experience_traces, snap.tension_traces,
            snap.frame_count, snap.profile_count
        ));
    }
    out.push('\n');
    ...
    out.push_str("| Tick | Entry | Expected | Detected | Coherence | Reflex | Passes | Exp traces |\n");
    out.push_str("|---|---|---|---|---|---|---|---|\n");
    for ev in events {
        ...
        out.push_str(&format!(
            "| {} | {} | {} | {} | {} | {} | {} | {} |\n",
            ev.tick, ev.entry_id, expected, detected,
