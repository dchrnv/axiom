-- Axiom OS PostgreSQL Schema v0.26.0
...
-- Example: Grant read/write to axiom_user
-- GRANT SELECT, INSERT, UPDATE ON ALL TABLES IN SCHEMA public TO axiom_user;
-- GRANT USAGE, SELECT ON ALL SEQUENCES IN SCHEMA public TO axiom_user;
-- GRANT EXECUTE ON FUNCTION archive_old_events(INTEGER) TO axiom_user;
...
-- Usage:
-- psql -U postgres -d axiom_db -f schema.sql
