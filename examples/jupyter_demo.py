#!/usr/bin/env python3
"""
Axiom Jupyter Integration - Live Demo
...
print("=" * 70)
print("Axiom Jupyter Integration - Live Demo")
print("=" * 70)
print()
...
print("-" * 70)
print("In Jupyter: %load_ext axiom_jupyter")
print()

# Import the extension components
try:
    from axiom_jupyter import AxiomMagics
    from axiom_jupyter.display import format_query_result_html
    print("✅ Extension loaded successfully!")
    print("   - AxiomMagics: OK")
...
print("-" * 70)
print("In Jupyter: %axiom init --path ./demo_graph.db")
print()
...
print("""
# Create users
alice = axiom_db.create_node(
    "user",
    {"name": "Alice", "age": 30, "city": "San Francisco"}
)

bob = axiom_db.create_node(
    "user",
...
axiom_db.create_edge(alice.id, project.id, "works_on")
axiom_db.create_edge(bob.id, project.id, "works_on")
""")
print()
print("Output:")
...
print("-" * 70)
print("In Jupyter: %axiom query \"find all nodes\"")
print()
...
print("│ node_003   │ project  │ {\"name\": \"Axiom\", \"status\": \"a...│")
print("└────────────┴──────────┴──────────────────────────────────────────┘")
print()
print("┌─────────────────────────────────────────────────────────────────┐")
print("│ 🔗 Edges: 2                                                      │")
...
print("-" * 70)
print("In Jupyter: %axiom query \"find all nodes where type='user'\"")
print()
print("Result:")
print("┌─────────────────────────────────────────────────────────────────┐")
print("│ 🔵 Nodes: 2                                                      │")
...
print("-" * 70)
print("In Jupyter: %axiom subscribe metrics")
print()
print("Output:")
...
print("%axiom emit metrics \"{'cpu': 85, 'memory': 70}\"")
print()
print("Output:")
print("⚠️ High CPU: 85%")
...
print("🚀 Key Features:")
print()
print("  • Magic Commands: %axiom for quick operations")
...
print("📚 Next Steps:")
print()
print("  1. Install: pip install axiom[jupyter]")
