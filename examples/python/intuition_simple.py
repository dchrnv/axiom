#!/usr/bin/env python3
"""
Axiom OS - IntuitionEngine Simple Demo
...
""")
    ...
    print()
    print("Code:")
    print("  intuition = axiom.IntuitionEngine.with_defaults()")
    print()
    ...
    print("Code:")
    print("  config = axiom.IntuitionConfig(")
    print("      analysis_interval_secs=30,")
    print("      min_confidence=0.8,")
    print("      enable_fast_path=True")
    print("  )")
    print("  intuition = axiom.IntuitionEngine.create(config=config)")
    print()
    ...
    intuition_custom = axiom.IntuitionEngine.create(config=config)
    ...
    print("Code:")
    print("  intuition = axiom.IntuitionEngine.create(")
    print("      capacity=50_000,")
    print("      channel_size=5_000")
    print("  )")
    print()

    intuition_builder = axiom.IntuitionEngine.create(
        capacity=50_000,
        channel_size=5_000
    )
