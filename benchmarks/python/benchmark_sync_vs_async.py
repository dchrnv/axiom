...
Compares performance of synchronous and asynchronous Axiom clients
...
from axiom import AxiomClient, AsyncAxiomClient


def benchmark_sync_sequential(client: AxiomClient, count: int) -> float:
...
async def benchmark_async_concurrent(client: AsyncAxiomClient, count: int) -> float:
...
async def benchmark_async_sequential(client: AsyncAxiomClient, count: int) -> float:
...
def run_benchmark_suite():
    ...
    print("=" * 60)
    print("Axiom Python Client Performance Benchmark")
    print("=" * 60)
    print()
