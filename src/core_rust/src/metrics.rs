...
lazy_static! {
    ...
    pub static ref CONNECTIONS_CREATED: IntCounter = register_int_counter!(
        "axiom_connections_created_total",
        "Total number of connections created"
    )
    .unwrap();
    ...
    pub static ref CONNECTIONS_VALIDATED: IntCounter = register_int_counter!(
        "axiom_connections_validated_total",
    ...
    pub static ref CONNECTIONS_REJECTED: IntCounter = register_int_counter!(
        "axiom_connections_rejected_total",
    ...
    pub static ref AGGRESSIVE_CLEANUPS: IntCounter = register_int_counter!(
        "axiom_aggressive_cleanups_total",
    ...
    pub static ref WAL_ENTRIES_WRITTEN: IntCounter = register_int_counter!(
        "axiom_wal_entries_written_total",
        "Total number of WAL entries written"
    )
    .unwrap();
    ...
    pub static ref WAL_ENTRIES_REPLAYED: IntCounter = register_int_counter!(
        "axiom_wal_entries_replayed_total",
...
lazy_static! {
    ...
    pub static ref GUARDIAN_EVENT_QUEUE_SIZE: IntGauge = register_int_gauge!(
        "axiom_guardian_event_queue_size",
...
lazy_static! {
    ...
    pub static ref TOKEN_CREATION_DURATION: Histogram = register_histogram!(
        "axiom_token_creation_duration_seconds",
    ...
    pub static ref CONNECTION_CREATION_DURATION: Histogram = register_histogram!(
        "axiom_connection_creation_duration_seconds",
    ...
    pub static ref VALIDATION_DURATION: Histogram = register_histogram!(
        "axiom_validation_duration_seconds",
    ...
    pub static ref WAL_WRITE_DURATION: Histogram = register_histogram!(
        "axiom_wal_write_duration_seconds",
...
lazy_static! {
    ...
    pub static ref TRACING_SAMPLES_RECORDED: IntCounter = register_int_counter!(
        "axiom_tracing_samples_recorded_total",
    ...
    pub static ref TRACING_SAMPLES_SKIPPED: IntCounter = register_int_counter!(
        "axiom_tracing_samples_skipped_total",
    ...
    pub static ref TRACING_ERROR_OPERATIONS: IntCounter = register_int_counter!(
        "axiom_tracing_error_operations_total",
    ...
    pub static ref TRACING_SLOW_OPERATIONS: IntCounter = register_int_counter!(
        "axiom_tracing_slow_operations_total",
    ...
    pub static ref TRACING_OVERHEAD_MS: Histogram = register_histogram!(
        "axiom_tracing_overhead_seconds",
...
///
/// ```rust
/// let metrics = axiom_core::metrics::export_metrics();
...
mod tests {
    ...
    fn test_export_metrics() {
        ...
        assert!(metrics.contains("axiom_tokens_created_total"));
        assert!(metrics.contains("axiom_memory_used_bytes"));
    }
