# Axiom Next.js Example

Example Next.js 14 application demonstrating Axiom TypeScript client integration.
...
- `NEXT_PUBLIC_NEUROGRAPH_API_URL` - Axiom API base URL
