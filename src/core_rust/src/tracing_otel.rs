...
//!
//! ```rust
//! use axiom_core::tracing_otel;
//!
//! // Initialize tracing with Jaeger
//! tracing_otel::init_tracer("axiom-api", "http://localhost:14268/api/traces")?;
//!
...
///
/// # Arguments
/// * `service_name` - Name of the service (e.g., "axiom-api")
...
///
/// ```rust
/// init_tracer("axiom-api", "http://jaeger:14268/api/traces")?;
/// ```
