"""
Axiom Client Exceptions

All exceptions raised by the Axiom client library.
"""
...
class AxiomError(Exception):
    """Base exception for all Axiom client errors."""
...
class AuthenticationError(AxiomError):
    """
...
class AuthorizationError(AxiomError):
    """
...
class RateLimitError(AxiomError):
    """
    Rate limit exceeded.
...
class ConnectionError(AxiomError):
    """
    Connection error.
