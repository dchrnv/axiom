...
Integration with axiom.Runtime v0.50.0 for persistent storage
...
class RuntimeTokenStorage(TokenStorageInterface):
    ...
    Integrates with axiom.Runtime v0.50.0 for persistent storage
    ...
    def __init__(self, runtime=None):
        ...
        Args:
            runtime: axiom.Runtime instance. If None, creates new instance.
        """
        if runtime is None:
            try:
...
class RuntimeGridStorage(GridStorageInterface):
    ...
    Uses Grid from axiom.Runtime v0.50.0 for spatial queries.
...
class RuntimeCDNAStorage(CDNAStorageInterface):
    ...
    Persists CDNA configuration through axiom.Runtime v0.50.0.
    """
