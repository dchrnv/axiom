#!/usr/bin/env python3
"""
Axiom OS - Token Batch Performance Demo
...
def demo_fast_method():
    ...
    start = time.time()
    tokens = axiom.Token.create_batch(count)
    duration = time.time() - start
...
def main():
    print("""
╔══════════════════════════════════════════════════════════════╗
║    Axiom OS - Batch API Performance Demo               ║
╚══════════════════════════════════════════════════════════════╝
...
""")
    ...
    print("  tokens = axiom.Token.create_batch(1_000_000)")
    print()
    print("✗ BAD - Avoid Python loops:")
    print("  tokens = [axiom.Token(i) for i in range(1_000_000)]")
    print()
