...
//
// Causal Frontier System V1: docs/spec/time/Causal Frontier System V1.md
// Механизм управления вычислениями через активную причинную границу
...
pub enum FrontierState {
    Empty,      // Frontier пуст
    Active,     // Нормальная обработка
    Storm,      // Causal storm detected
    Stabilized, // Возврат к нормальному состоянию после storm
    Idle,       // Нет активных событий, система в покое
}
