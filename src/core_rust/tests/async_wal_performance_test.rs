// Axiom - Async WAL Performance Test v0.44.2
...
const SYNC_WAL_PATH: &str = "/tmp/axiom_sync_wal_perf.wal";
const ASYNC_WAL_PATH: &str = "/tmp/axiom_async_wal_perf.wal";
...
async fn test_async_wal_integrity() {
    ...
    let test_path = "/tmp/axiom_async_integrity_test.wal";
