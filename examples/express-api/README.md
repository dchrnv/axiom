# Axiom Express.js API Example

Example Express.js REST API that integrates with Axiom for semantic document management.
...
```bash
docker build -t axiom-express-api .
docker run -p 3001:3001 --env-file .env axiom-express-api
```
