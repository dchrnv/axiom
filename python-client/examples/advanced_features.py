"""
Advanced features examples for Axiom Python client.
...
def example_cli_usage():
    ...
    # Create token
    $ axiom-cli token create "hello world" --username developer --password developer123
    ...
    # Enable debug logging
    $ axiom-cli --debug token list

    # Use API key for auth
    $ axiom-cli --api-key "ng_your_key_here" token list
    """)
