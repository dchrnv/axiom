...
///
/// ```rust
/// use axiom_core::panic_handler::catch_panic;
///
...
///
/// ```rust
/// use axiom_core::panic_handler::catch_panic_async;
///
...
///
/// ```rust
/// use axiom_core::panic_handler::install_panic_hook;
///
/// install_panic_hook();
///
/// // Application code...
...
pub fn install_panic_hook() {
    panic::set_hook(Box::new(|panic_info| {
        ...
        let timestamp = std::time::SystemTime::now()
            ...
            .unwrap()
            .as_secs();
        let dump_path = format!("axiom_crash_dump_{}.json", timestamp);
...
///
/// ```rust
/// use axiom_core::recover_panic_async;
///
