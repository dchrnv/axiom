"""
Helper functions and extensions for Axiom Jupyter integration.
...
class QueryResultExtensions:
    ...
    def to_dataframe(result, include_properties: bool = True):
        ...
        Example:
            result = %axiom query "find all nodes where type='user'"
...
def install_result_extensions():
    ...
    """
    try:
        from axiom.query.result import QueryResult
