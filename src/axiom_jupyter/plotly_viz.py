"""
Plotly-based interactive graph visualizations for Axiom.
...
def render_interactive_graph(
    ...
    Example:
        result = %axiom query "find all nodes"
        from axiom_jupyter.plotly_viz import render_interactive_graph
...
def render_3d_graph(
    ...
    Example:
        result = %axiom query "find all nodes"
        from axiom_jupyter.plotly_viz import render_3d_graph
