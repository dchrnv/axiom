 ...
 *
 * Provides a mock implementation of AxiomClient that simulates
...
/**
 * Mock Axiom client for unit testing.
 *
 * @example
 * ```typescript
 * import { MockAxiomClient } from '@axiom/client/testing';
 *
 * describe('MyApp', () => {
 *   it('should create token', async () => {
 *     const client = new MockAxiomClient();
...
class MockTokensResource {
  constructor(private client: MockAxiomClient) {}
