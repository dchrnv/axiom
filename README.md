...
[![Tests](https://img.shields.io/badge/tests-1608%20passing-brightgreen.svg)]()
...
**Axiom is in active development — core architecture complete, 1608 tests passing.**
...
cd axiom
cargo test --workspace   # 1608 тестов
