...
**Версия:** 1.1 (ревизия после review)  
**Дата:** 2026-03-21  
**Назначение:** Пошаговый план перехода от monorepo к Cargo Workspace  
...
6. `cargo build` должен успешно компилировать пустой workspace.
...
5. Добавить примеры конфигурации для всех 11 доменов Ashti_Core V2.0 в `config/schema/domains.yaml`.
...
9. Документация (specs/) перемещена в docs/specs/.
