"""
# ruff: noqa: F841,E712
Unit tests for Axiom Jupyter Integration.
...
def test_query_builder_basic():
    ...
    spec = importlib.util.spec_from_file_location(
        "query_builder",
        Path(__file__).parent.parent.parent / "src/axiom_jupyter/query_builder.py"
    )
...
def test_to_dict_list():
    ...
    spec = importlib.util.spec_from_file_location(
        "helpers",
        Path(__file__).parent.parent.parent / "src/axiom_jupyter/helpers.py"
    )
