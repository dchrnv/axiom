"""Runtime management for axiom library."""

import logging
from pathlib import Path
from typing import Any, Dict, Optional

from axiom.exceptions import BootstrapError, ConfigError, RuntimeError
...
from axiom.types import EmbeddingFormat

logger = logging.getLogger(__name__)


class Config:
    """Configuration for axiom Runtime.
...
class Runtime:
    """Main runtime interface for axiom.
