"""
Axiom CLI - Command-line interface for Axiom API.

Usage:
    axiom-cli health
    axiom-cli token create "hello world"
    axiom-cli token get 123
    axiom-cli token list --limit 10
    axiom-cli token query --text "hello" --top-k 5
    axiom-cli apikey create --name "My Key" --expires 30
    axiom-cli apikey list
"""
...
from .exceptions import AxiomError
from .logging import setup_logging, get_logger
import logging


def create_client(args) -> AxiomClient:
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Axiom CLI - Command-line interface for Axiom API"
    )
