"""
Quick Start Example for Axiom Jupyter Integration

This script demonstrates basic usage of Axiom in Jupyter notebooks.
...
# ============================================================================
# %axiom query "find all nodes where age > 28"
...
if __name__ == "__main__":
    print("=" * 70)
    print("Axiom Jupyter Quick Start")
    print("=" * 70)
    print()
    ...
    print()
    print("Quick setup:")
    print("1. pip install axiom[jupyter]")
